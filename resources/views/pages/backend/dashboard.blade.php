<x-app-layout>
    <x-backend.card>
        ...
        <div class="flex flex-wrap -m-4 text-center">
            ...
            <div class="w-full p-4 md:w-1/4 sm:w-1/2">
                <div class="px-4 py-6 border-2 border-gray-200 rounded-lg">
                    <svg viewBox="0 0 32 32" width="64" height="64" xmlns="http://www.w3.org/2000/svg" class="inline-block">
                        <defs>
                    ...
                    <h2 class="text-3xl font-medium text-gray-900 title-font">{{ $usersCount }}</h2>
            ...
            <div class="w-full p-4 md:w-1/4 sm:w-1/2">
                <div class="px-4 py-6 border-2 border-gray-200 rounded-lg">
                    ...
                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="64px"
                        ...
                        <path class="cls-1"
                            d="M281.6,320H230.4a12.8,12.8,0,0,1,0-25.6h51.2a12.8,12.8,0,0,1,0,25.6Z" />
                    </svg>
